<template>
  ...
  >
    ...
    <!-- Tooltip al hover -->
    <span
      class="absolute right-full mr-3 bg-gray-900 text-white text-sm font-medium px-3 py-2 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
    >
